...
import kg.exam9.forum.service.AuthorService;
...
public class AuthorController {
    ...
    {
        var user = authorService.getByEmail(principal.getName());
    ...
    public String registerPage(@Valid AuthorRegisterForm authorRequestDto,
        ...
        authorService.register(authorRequestDto);
    ...
    public String submitResetPasswordPage(@RequestParam("token") String token,
        ...
        Author author = repository.findById(pToken.getAuthor().getId()).get();
